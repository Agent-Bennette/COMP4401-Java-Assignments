...
public class Comp4401PanEdwAssignment7_Main extends JPanel
{
    ...
    static JButton bRickRoll =              new JButton("") ;
    
    //Setting up boolean variable for special actions
    static boolean editableDisplay = true ;
    ...
    public static void main ( String [] args )
    {
        ...
        displayPanelInputs.add( bRickRoll ) ;
        ...
        bRickRoll.setBackground( Color.black ) ;
        bRickRoll.setBorder ( BorderFactory.createLineBorder ( Color.darkGray ) ) ;
    ...
    { 
        ...
        { 
            ...
            if (e.getSource() == bFunctionBackspace) 
            {
                ...
                if ( displayInput.getText().equals("Infinity") || displayInput.getText().equals("NaN") )
                {
                    
                    displayInput.setText("") ;
                    SAMAutoClearDisplay(1) ;
            ...
            if (e.getSource() == bFunctionEquals)
            {
                ...
                if ( displayFormula.getText().equals("") )
                {
                
                    displayFormula.setText( displayInput.getText() ) ;
                    displayInput.setText("") ;
                ...
                */
                    ...
                    //System.out.println("CONTENT of displayFormula : " + displayFormula.getText()) ;
                    //System.out.println("CONTENT of SRMDobuleSpaceRemover Result : " + SRMDoubleSpaceRemover(displayFormula.getText())) ;
                    //System.out.println("CONTENT of Calculate Method Result : " + Calculate(SRMDoubleSpaceRemover(displayFormula.getText()))) ;
               
                displayFormula.setText ( Calculate( SRMDoubleSpaceRemover ( displayFormula.getText() ) ) ) ;
                
                SAMAutoClearDisplay(2) ;
            ...
            if (e.getSource() == bMathSquare) 
            {
                ...
                else
                {
                    ...
                    displayFormula.setText ( displayFormula.getText() + " ^2 " ) ;
            ...
            if (e.getSource() == bRickRoll )
            {
                ...
                try 
                {
                    ...
                    dt.browse(uri);
                    System.out.println("RickRolled!") ;
                    
                }
                catch (Exception exception)
                {
                    
                    System.out.println("Throws exception occured. Not sure what to do here.") ;
         ...
         *      output   :   String of result
         */
        private static String Calculate ( String formula )
        {
            
            String [] formulaPart = formula.split("~") ;
            String result = "" ;
            
                //DEVELOPPER'S USAGE ONLY
                //System.out.println("Calculate() INPUT formula : " + formula) ;
                //for ( int i = 0 ; i < formulaPart.length ; i ++ )
                //{
                //    
                //    System.out.println("Calculate() VARIABLE formulaPart [" + i + "] : " + formulaPart[i]) ;
                //    
                //}
            
            if ( formulaPart.length > 4 )
            {
                
                result = formula + "ERROR - OVERLOAD OF DATA" ;
                
            }
            else if ( formulaPart.length == 1 )
            {
                
                result = formula ;
                
            }
            else if ( formulaPart [ 1 ].equals("\u00b1") )
            {
                
                result = Double.toString( Double.parseDouble( formulaPart [ 0 ] ) * - 1 ) ;
                
            }
            else if ( formulaPart [ 1 ].equals("+") )
            {
                
                result = Double.toString( ( Double.parseDouble( formulaPart [ 0 ] ) + Double.parseDouble( formulaPart [ 2 ] ) ) ) ;
            ...
            else if ( formulaPart [ 1 ].equals("^2") )
            {
                
                result = Double.toString( Math.pow( Double.parseDouble( formulaPart [ 0 ] ) , 2 ) ) ;
                
            }
            else if ( formulaPart [ 0 ].equals("\u221a") )
            {
                
                result = Double.toString( Math.pow( Double.parseDouble( formulaPart [ 1 ] ) , 0.5 ) ) ;
                
            }
            else if ( formulaPart [ 1 ].equals("^") )
            {
                
                result = Double.toString( Math.pow ( Double.parseDouble ( formulaPart [ 0 ] ) , Double.parseDouble ( formulaPart [ 2 ] ) ) ) ;
                
            }
            else if ( formulaPart [ 1 ].equals("%") )
            {
                
                result = Double.toString( ( Double.parseDouble( formulaPart [ 0 ] ) * 100 ) ) ;
                
            }
            else if ( formulaPart [ 1 ].equals("1/all") )
            {
                
                result = Double.toString( ( 1 / Double.parseDouble( formulaPart [ 0 ] ) ) ) ;
                
            }
            else
            {
                
                result = formula + "ERROR - SYNTAX" ;
        ...
        public static String SRMDoubleSpaceRemover ( String input )
        {
            ...
            boolean noFaults = false ;
                ...
                //DEVELOPPER'S USAGE ONLY
                //System.out.println("SRMDoubleSpaceRemover VARIABLE input (before changes) : " + input) ;
            ...
            while ( noFaults == false )
            {
                ...
                //DEVELOPPER'S USAGE ONLY
                //System.out.println("SRMDoubleSpaceRemover VARIABLE input (After initial space removal) : " + input) ;
            
            char [] inputInCharArray = input.toCharArray() ;
            for ( int replacingSlot = 0 ; replacingSlot < inputInCharArray.length ; replacingSlot ++ )
            {
                
                if ( inputInCharArray [ replacingSlot ] == ' ' )
                {
                    
                    inputInCharArray [ replacingSlot ] = '~' ;
                    
                }
                
                    //DEVELOPPER'S USAGE ONLY
                    //System.out.print("SRMDoubleSpaceRemover ARRAY inputInCharArray (During converter) for[" + replacingSlot + "] ) : ") ;
                    //for ( int i = 0 ; i < inputInCharArray.length ; i ++ )
                    //{
                    //    
                    //    System.out.print(inputInCharArray[i] + "_" ) ;
                    //    
                    //}
                    //System.out.println() ;
            ...
            input = "" ;
            for ( int addSlot = 0 ; addSlot < inputInCharArray.length ; addSlot ++ )
            {
                
                if ( addSlot == 1 )
                {
                    
                    if ( inputInCharArray[0] == '~' )
                    {
                ...
                input = input + inputInCharArray [ addSlot ] ;
                
            }
            
                //DEVELOPPER'S USAGE ONLY
                //System.out.println("SRMDoubleSpaceRemover VARIABLE input (Reconverted after char Array) : " + input) ;
        ...
        /**
         *      SPECIAL ACTION METHOD - Auto Clear Display
         */
        public static void SAMAutoClearDisplay( int situation )
        {
            ...
            switch ( situation )
            {
                ...
                case 1 : // Allow formula recycling
                    editableDisplay = true ;
                    break;
                    
                case 2 : // End formula recycling 
